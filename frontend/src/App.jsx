      ...
      {showLoginForm ? (
        ...
        <div className="flex flex-col items-center pt-[20vh] h-screen bg-gray-900 text-gray-100">
          ...
          {selectedSymptoms.length > 0 && (
            <>
              <div className="mt-4 w-[80vw] max-w-[800px] bg-[#0a101f] rounded-md p-4">
                <h3 className="text-lg font-bold text-blue-400 mb-3">Selected Symptoms:</h3>
                <div className="flex flex-wrap gap-2">
                  {selectedSymptoms.map((symptom, index) => (
                    <div
                      key={index}
                      className="flex items-center bg-blue-600 text-white px-3 py-0.5 rounded-xl"
                    >
                      <span>{symptom}</span>
                      <button
                        onClick={() => {
              ...
              <div className="mt-4 w-[80vw] max-w-[800px] flex justify-end">
                <button
                  onClick={handleSubmit}
                  className="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-2 px-6 rounded-md transition-colors duration-200"
                >
                  Submit Symptoms
                </button>
              </div>
